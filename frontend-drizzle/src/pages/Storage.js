...
@connect(
  (state, ownProps) => {
    const formValues = state.form.value.values
    const formErrors = getFormSyncErrors('value')(state)
    const formValid = isValid('value')(state)
...
class Storage extends React.Component {
  ...
  */
  ...
  render() {
    ...
    //const dataKey = this.contracts.KeyValue.methods.getValue.cacheCall()
